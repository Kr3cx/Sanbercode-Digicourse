        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="text-info mb-0">Review</h3>
                    @php
                        $averageRating = $films->listReviews->avg('point');
                        $averageRating = number_format($averageRating, 1); 
                    @endphp
                    @if ($films->listReviews->count() > 0)
                        <div class="d-flex align-items-center">
                            <span class="badge bg-warning text-dark ms-2">
                                <i class="fas fa-star text-dark"></i> {{ $averageRating }}/5
                            </span>
                        </div>
                    @else
                        <span class="badge bg-secondary ms-2">Belum ada rating</span>
                    @endif
                </div>
